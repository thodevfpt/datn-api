    ...
    <div class="container">
      <div class="col-lg-6 m-auto bd-m p-0">
        <div class="header_mail">
          <span class="text-150 text-white">Đơn hàng mới của khách hàng</span>
        </div>
            ...
            <div class="text-95 text-secondary-d3">
              <div class="row mb-sm-0 py-3 bt_1">
                ...
                <div class="col-lg-4 col-md-4 col-4">
                  <span class="text-120 text-center d-block fz-mb">1.180.000 đ</span>
                </div>
              </div>
              <div class="row mb-sm-0 py-3 bt_1">
                <div class="col-lg-8 col-md-8 col-8 fz-mb">
                ...
                <div class="col-lg-4 col-md-4 col-4">
                  <span class="text-110 text-center d-block fz-mb">180.000 đ</span>
                </div>
              </div>
              <div class="row mb-sm-0 py-3 bt_1">
                <div class="col-lg-8 col-md-8 col-8 fz-mb">
                ...
                <div class="col-lg-4 col-md-4 col-4">
                  <span class="text-110 text-center d-block fz-mb">Không có</span>
                </div>
              </div>
              <div class="row mb-sm-0 py-3 bt_1">
                <div class="col-lg-8 col-md-8 col-8 fz-mb">
                ...
                <div class="col-lg-4 col-md-4 col-4">
                  <span class="text-110 text-center d-block fz-mb">Thanh toán khi nhận hàng</span>
                </div>
              </div>
              <div class="row mb-sm-0 py-3 bt_1">
                <div class="col-lg-8 col-md-8 col-8 fz-mb">
                ...
                <div class="col-lg-4 col-md-4 col-4">
                  <span class="text-150 text-center d-block fz-mb">1.360.000 đ</span>
                </div>
              </div>
            </div>
          </div>
